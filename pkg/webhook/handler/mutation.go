...
//+kubebuilder:webhook:admissionReviewVersions=v1beta1,path=/mutate,mutating=true,failurePolicy=fail,groups="",resources=pods,verbs=create;update,versions=v1,sideEffects=none,name=pod-annotate-webhook.slok.dev
